...
Amazon Macie scans S3 resources for PHI patterns including SSNs, MRNs, dates of birth, and clinical notes. Detection runs automatically. Findings write to Security Hub for centralized visibility.
